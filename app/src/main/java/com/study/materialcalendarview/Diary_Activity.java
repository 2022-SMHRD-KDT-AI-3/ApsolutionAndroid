...
public class Diary_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diary_back = findViewById(R.id.diary_back);
        ...
        materialCalendarView.setOnDateChangedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                ...
                Toast.makeText(Diary_Activity.this, shot_Day , Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Diary_Activity.this, Diary_List_Activity.class);
    ...
    public void calendarInit() {
        ...
        materialCalendarView.addDecorators(
                ...
                new DayDecorator(Diary_Activity.this),
                oneDayDecorator);
    }
    ...
    private class ApiSimulator extends AsyncTask<Void, Void, List<CalendarDay>> {
        ...
        protected void onPostExecute(@NonNull List<CalendarDay> calendarDays) {
            ...
            materialCalendarView.addDecorator(new EventDecorator(Color.RED, calendarDays, Diary_Activity.this));
        }
    }
