...
public class CameraActivity extends AppCompatActivity {
    ...
    private Button btn_gallery, btn_send, btn_capture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CameraActivity.this, activity_resultcheck.class);
    ...
    private void camera_open_intent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri providerURI = FileProvider.getUriForFile(this, "com.study.materialcalendarview.fileprovider", photoFile);
